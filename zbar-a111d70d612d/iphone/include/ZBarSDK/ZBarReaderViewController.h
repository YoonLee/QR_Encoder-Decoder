...
@protocol ZBarReaderViewControllerDelegate
    ...
    : UIViewController
{
	...
	id <ZBarReaderViewControllerDelegate> cancelDelegate;
...
@property (nonatomic, assign) id <ZBarReaderViewControllerDelegate> cancelDelegate;
