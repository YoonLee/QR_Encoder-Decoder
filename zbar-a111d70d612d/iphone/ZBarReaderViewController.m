...
readerView, scanCrop, cancelDelegate;
...
- (void) initControls
{
    ...
    r.origin.y = r.size.height - 40.0f;
    r.size.height = 40.0f;
    ...
    r.origin.y = 0;
    toolbar.frame = r;
    [toolbar setTintColor:[UIColor colorWithRed:0.0f green:0.184f blue:0.427f alpha:1.0f]];
...
- (void) flash
{
    if (readerView.torchMode == UIImagePickerControllerCameraFlashModeOff || readerView.torchMode == UIImagePickerControllerCameraFlashModeAuto)
...
- (void) cancel
{
    ...
    [[self cancelDelegate] didUserTabTheCancelButton];
}
